...
using MKopaMessageBox.Extenstions;
using MKopaMessageBox.Extenstions.Middleware;
using MKopaMessageBox.Persistence;
using MKopaMessageBox.Persistence.ModelBuilders;
using Serilog;
...
try { app.SeedDefaultsData().Wait(); } catch (Exception ex) { Log.Error(ex.Message, ex); }
